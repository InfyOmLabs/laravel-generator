...
class ModelGenerator extends BaseGenerator
{
    ...
    private function getPHPDocType($db_type, $relation = null, $relationText = null)
    {
        ...
        switch ($db_type) {
            ...
            case '1t1':
                return '\\'.$this->commandData->config->nsModel.'\\'.$relation->inputs[0].' '.camel_case($relationText);
            case 'mt1':
            ...
            case 'mtm':
            case 'hmt':
                return '\Illuminate\Database\Eloquent\Collection'.' '.camel_case(str_plural($relationText));
            default:
