...
class RequestGenerator extends BaseGenerator
{
    ...
    public function __construct(CommandData $commandData)
    {
        ...
        $this->createFileName = 'Create'.$this->commandData->modelName.($this->commandData->config->appendSuffixToFileName ? $this->commandData->config->requestNameSuffix : '') . '.php';
        $this->updateFileName = 'Update'.$this->commandData->modelName.($this->commandData->config->appendSuffixToFileName ? $this->commandData->config->requestNameSuffix : '') . '.php';
    }
