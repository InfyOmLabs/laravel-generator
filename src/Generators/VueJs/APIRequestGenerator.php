...
class APIRequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = InfyOmHelpers::get_template('vuejs.request.create_request', 'laravel-generator');
    ...
    {
        $templateData = InfyOmHelpers::get_template('vuejs.request.update_request', 'laravel-generator');
