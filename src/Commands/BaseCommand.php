...
class BaseCommand extends Command
{
    ...
    {
        return [
            ['fieldsFile', 'ff', InputOption::VALUE_REQUIRED, 'Fields input as json file'],
            ['jsonFromGUI', 'jg', InputOption::VALUE_REQUIRED, 'Direct Json string while using GUI interface'],
            ['plural', 'pl', InputOption::VALUE_REQUIRED, 'Plural Model name'],
            ['tableName', 't', InputOption::VALUE_REQUIRED, 'Table Name'],
            ['fromTable', 'ft', InputOption::VALUE_NONE, 'Generate from existing table'],
            ['ignoreFields', 'if', InputOption::VALUE_REQUIRED, 'Ignore fields while generating from table'],
            ['save', 's', InputOption::VALUE_NONE, 'Save model schema to file'],
            ['primary', 'p', InputOption::VALUE_REQUIRED, 'Custom primary key'],
            ['prefix', 'pf', InputOption::VALUE_REQUIRED, 'Prefix for all files'],
            ['paginate', 'pg', InputOption::VALUE_REQUIRED, 'Pagination for index.blade.php'],
            ...
            ['datatables', 'dt', InputOption::VALUE_REQUIRED, 'Override datatables settings'],
            ['views', 'v', InputOption::VALUE_REQUIRED, 'Specify only the views you want generated: index,create,edit,show'],
            ['relations', 'r', InputOption::VALUE_NONE, 'Specify if you want to pass relationships for fields'],
            ['softDelete', 'sd', InputOption::VALUE_NONE, 'Soft Delete Option'],
            ['forceMigrate', 'fm', InputOption::VALUE_NONE, 'Specify if you want to run migration or not'],
